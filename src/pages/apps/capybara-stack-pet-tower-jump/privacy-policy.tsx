...
const CapybaraStackPetTowerJump: React.FC = () => {
  return (
    <>
      <Head>
        <title>Capybara Stack: Pet Tower Jump | Privacy Policy</title>
        <link rel="icon" href="/capybara-stack-pet-tower-jump.ico" />
      </Head>
      ...
      >
        <>
          ...
          <p>
            This privacy policy applies to the Capybara Stack: Pet Tower Jump
            app (hereby referred to as "Application") for mobile devices that
            was created by Augsync (hereby referred to as "Service Provider") as
          ...
          <p>
            ...
            augustobarco.dev@gmail.com and they will respond in a reasonable
            time.
          </p>
          <p>
          ...
          <p>
            ...
            please contact the Service Provider (augustobarco.dev@gmail.com) so
          ...
          <p>This privacy policy is effective as of 2024-11-09</p>
          <p>
          ...
          <p>
            ...
            the Service Provider via email at augustobarco.dev@gmail.com.
          </p>
          <hr />
          <p>
...
export default CapybaraStackPetTowerJump;
