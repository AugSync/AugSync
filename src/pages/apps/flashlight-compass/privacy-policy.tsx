...
const FlashlightCompass: React.FC = () => {
  return (
    <>
      <Head>
        <title>Flashlight Compass | Privacy Policy</title>
        <link rel="icon" href="/flashlight-compass.ico" />
      </Head>
      ...
      >
        <>
          ...
          <p>
            This privacy policy applies to the Flashlight Compass app (hereby
...
export default FlashlightCompass;
