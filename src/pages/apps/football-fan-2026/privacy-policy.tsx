...
const FootballFan2026: React.FC = () => {
  return (
    <>
      <Head>
        <title>Football Fan 2026 | Privacy Policy</title>
        <link rel="icon" href="/football-fan-2026.ico" />
      </Head>
      ...
      >
        <>
          ...
          <p>
            This privacy policy applies to the Football Fan 2026 app (hereby
          ...
          <p>This privacy policy is effective as of 2026-04-07</p>
          <p>
...
export default FootballFan2026;
