...
const LifeCalendar: React.FC = () => {
  return (
    <>
      <Head>
        <title>Life Calendar | Privacy Policy</title>
        <link rel="icon" href="/life-calendar.ico" />
      </Head>
      ...
      >
        <>
          ...
          <p>
            This privacy policy applies to the Life Calendar app (hereby
          ...
          <p>This privacy policy is effective as of 2026-08-25</p>
          <p>
