...
const LudoSavage: React.FC = () => {
  return (
    <>
      <Head>
        <title>Ludo Savage | Privacy Policy</title>
        <link rel="icon" href="/ludo-savage.ico" />
      </Head>
      ...
      >
        <>
          ...
          <p>
            This privacy policy applies to the Ludo Savage app (hereby referred
            to as "Application") for mobile devices that was created by Augsync
